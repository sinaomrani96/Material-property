...
#include "MyFluidProperty.h"
#include "NewtonInversion.h"

registerMooseObject("FluidPropertiesApp", MyFluidProperty);

InputParameters
MyFluidProperty::validParams()
{
...
MyFluidProperty::MyFluidProperty(const InputParameters & parameters)
  : SinglePhaseFluidProperties(parameters),
    ...
    _viscosity1(getMaterialProperty<Real>("viscosity1")),
    _density0(getParam<Real>("density0")),
    _pp_coeff(getParam<Real>("porepressure_coefficient"))
{
}

MyFluidProperty::~MyFluidProperty() {}

std::string
MyFluidProperty::fluidName() const
{
  return "simple_fluid";
}

Real
MyFluidProperty::molarMass() const
{
  return _molar_mass;
}

Real MyFluidProperty::beta_from_p_T(Real /*pressure*/, Real /*temperature*/) const
{
  return _thermal_expansion;
}

void
MyFluidProperty::beta_from_p_T(
...
Real MyFluidProperty::cp_from_p_T(Real /*pressure*/, Real /*temperature*/) const
{
  return _cp;
}

void
MyFluidProperty::cp_from_p_T(
...
Real MyFluidProperty::cp_from_v_e(Real /*v*/, Real /*e*/) const { return _cp; }

void
MyFluidProperty::cp_from_v_e(Real v, Real e, Real & cp, Real & dcp_dv, Real & dcp_de) const
{
  cp = cp_from_v_e(v, e);
  dcp_dv = 0.0;
  dcp_de = 0.0;
...
Real MyFluidProperty::cv_from_p_T(Real /*pressure*/, Real /*temperature*/) const
{
  return _cv;
}

void
MyFluidProperty::cv_from_p_T(
...
Real MyFluidProperty::cv_from_v_e(Real /*v*/, Real /*e*/) const { return _cv; }

void
MyFluidProperty::cv_from_v_e(Real v, Real e, Real & cv, Real & dcv_dv, Real & dcv_de) const
{
  cv = cv_from_v_e(v, e);
  dcv_dv = 0.0;
  dcv_de = 0.0;
...
Real
MyFluidProperty::c_from_p_T(Real pressure, Real temperature) const
{
  return std::sqrt(_bulk_modulus / rho_from_p_T(pressure, temperature));
}

void
MyFluidProperty::c_from_p_T(
...
Real
MyFluidProperty::c_from_v_e(Real v, Real e) const
{
...
void
MyFluidProperty::c_from_v_e(Real v, Real e, Real & c, Real & dc_dv, Real & dc_de) const
{
  Real T = T_from_v_e(v, e);
  Real p = p_from_v_e(v, e);
...
Real MyFluidProperty::k_from_p_T(Real /*pressure*/, Real /*temperature*/) const
{
  return _thermal_conductivity;
}

void
MyFluidProperty::k_from_p_T(
...
Real MyFluidProperty::k_from_v_e(Real /*v*/, Real /*e*/) const
{
  return _thermal_conductivity;
}

void
MyFluidProperty::k_from_v_e(
...
Real MyFluidProperty::s_from_p_T(Real /*pressure*/, Real /*temperature*/) const
{
  return _specific_entropy;
}

void
MyFluidProperty::s_from_p_T(
...
Real MyFluidProperty::s_from_h_p(Real /*enthalpy*/, Real /*pressure*/) const
{
  return _specific_entropy;
}

Real MyFluidProperty::s_from_v_e(Real /*v*/, Real /*e*/) const { return _specific_entropy; }

void
MyFluidProperty::s_from_v_e(
...
Real
MyFluidProperty::rho_from_p_T(Real pressure, Real temperature) const
{
  return _density0 * std::exp(pressure / _bulk_modulus - _thermal_expansion * temperature);
}

void
MyFluidProperty::rho_from_p_T(
...
void
MyFluidProperty::rho_from_p_T(const DualReal & pressure,
...
Real
MyFluidProperty::T_from_v_e(Real /*v*/, Real e) const
{
...
Real
MyFluidProperty::T_from_v_h(Real v, Real h) const
{
...
void
MyFluidProperty::T_from_v_h(Real v, Real h, Real & T, Real & dT_dv, Real & dT_dh) const
{
  T = T_from_v_h(v, h);
  dT_dv =
...
void
MyFluidProperty::T_from_v_e(Real v, Real e, Real & T, Real & dT_dv, Real & dT_de) const
{
  T = T_from_v_e(v, e);
  dT_dv = 0.0;
  dT_de = 1.0 / _cv;
...
Real
MyFluidProperty::T_from_p_rho(Real p, Real rho) const
{
...
void
MyFluidProperty::T_from_p_rho(Real p, Real rho, Real & T, Real & dT_dp, Real & dT_drho) const
{
...
Real
MyFluidProperty::T_from_p_h(Real p, Real h) const
{
...
Real
MyFluidProperty::p_from_v_e(Real v, Real e) const
{
...
void
MyFluidProperty::p_from_v_e(Real v, Real e, Real & p, Real & dp_dv, Real & dp_de) const
{
  p = p_from_v_e(v, e);
...
Real
MyFluidProperty::p_from_v_h(Real v, Real h) const
{
...
void
MyFluidProperty::p_from_v_h(Real v, Real h, Real & p, Real & dp_dv, Real & dp_dh) const
{
  Real T, dT_dv, dT_dh;
...
Real
MyFluidProperty::e_from_p_T(Real /*pressure*/, Real temperature) const
{
  return _cv * temperature;
}

void
MyFluidProperty::e_from_p_T(
...
Real
MyFluidProperty::e_from_p_rho(Real p, Real rho) const
{
...
void
MyFluidProperty::e_from_p_rho(Real p, Real rho, Real & e, Real & de_dp, Real & de_drho) const
{
...
Real
MyFluidProperty::e_from_v_h(Real v, Real h) const
{
  Real T = T_from_v_h(v, h);
...
void
MyFluidProperty::e_from_v_h(Real v, Real h, Real & e, Real & de_dv, Real & de_dh) const
{
  Real T, dT_dv, dT_dh;
  Real p, dp_dv, dp_dh;
  T_from_v_h(v, h, T, dT_dv, dT_dh);
...
Real MyFluidProperty::mu_from_p_T(Real /*pressure*/, Real /*temperature*/) const
{
  return _viscosity1[_qp];
}


 void
MyFluidProperty::mu_from_p_T(
...
Real MyFluidProperty::mu_from_v_e(Real /*v*/, Real /*e*/) const { return _viscosity1[_qp]; }

void
MyFluidProperty::mu_from_v_e(Real v, Real e, Real & mu, Real & dmu_dv, Real & dmu_de) const
{
...
Real
MyFluidProperty::h_from_p_T(Real pressure, Real temperature) const
{
