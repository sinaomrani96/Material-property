 ...
 */
template <bool is_ad>
class MyFluidTempl : public PorousFlowFluidPropertiesBaseTempl<is_ad>
{
public:
  static InputParameters validParams();

  MyFluidTempl(const InputParameters & parameters);
...
protected:
  ...
  const MaterialProperty<Real> & _viscosity1;

  usingPorousFlowFluidPropertiesMembers;
};

typedef MyFluidTempl<false> MyFluid;
typedef MyFluidTempl<true> ADMyFluid;
